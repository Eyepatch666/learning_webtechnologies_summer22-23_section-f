                ...
                <form method="post" action="../controller/adminblogval.php" enctype="">
                    <fieldset>
                        ...
                        <table>
                            ...
                            <br><br>
                            |<a href="allcontents.php">Your_Contents</a> ||<a href="courses.php">Create_Courses</a> | <a href="../controller/logout.php">Logout</a> | <a href="search_course.php">Search Course</a> 
